Generate a concise test suite for this Python code using `pytest` that covers:

- Typical usage flows such as adding, removing, retrieving, and updating questions.
- For each test, ensure it matches the intended behavior described in the comments within controllers/question_controller.py.
